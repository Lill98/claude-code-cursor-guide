# Claude Code: Rules, Commands, Hooks, Skills

This document explains the 4 core mechanisms for customizing and extending Claude Code, with practical examples from the **saafehouse-be** project (NestJS + Prisma + RBAC + multi-tenant).

---

## Overview of the 4 Types
...
# 4. Set up hooks in settings.json
